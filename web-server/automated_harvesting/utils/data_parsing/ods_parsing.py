...
def insert_data_from_row_ods(sheet_table_name, field_names, values, is_dynamic, static_column_names, dynamic_column_names, static_table_name, dynamic_table_name):
    if is_dynamic:
...
def process_ods_rows(ods_sheet, header_row_index, valid_columns, field_names, sheet_table_name, is_dynamic, static_column_names, dynamic_column_names, static_table_name, dynamic_table_name):
    for row_idx, row in enumerate(ods_sheet.rows()):
        ...
        insert_data_from_row_ods(sheet_table_name, field_names, values, is_dynamic, static_column_names, dynamic_column_names, static_table_name, dynamic_table_name)
...
def process_ods_sheet(ods_sheet, sheet_name, table_name, id):
    ...
    try:
        process_ods_rows(ods_sheet, header_row_index, valid_columns, field_names, sheet_table_name, is_dynamic, static_column_names, dynamic_column_names, static_table_name, dynamic_table_name)
    except Exception as create_table_error:
