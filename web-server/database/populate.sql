...
VALUES
    ...
    (3, 2, 4, 2, 'Etablissements EHPAD, ESLD, résidences autonomie, accueils de jour', 9, 2, 6),
    (1, 2, 6, NULL, 'landes - Postes d''appel d''urgence', 4, 1, 2),
    (1, 2, 6, NULL, 'L''accessibilité potentielle localisée (APL)', 11, 2, 7),
    (1, 2, 7, 3, 'Episodes de pollution pour les départements de Nouvelle-Aquitaine pour l''année dernière et jusqu''à la veille', 12, 3, 8),
    (3, 2, 7, 5, 'Accessibilité des Traversées Piétonnes - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 9),
    (3, 2, 7, 5, 'Niveau d''accessibilité des cheminements piétons - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 10),
    (3, 2, 7, 5, 'Cheminements rétrécis pour piétons - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 11),
    (3, 2, 7, 5, 'Obstacles linéaires sur les cheminements piétons - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 12),
    (3, 2, 7, 5, 'Accessibilité des grilles - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 13),
    (3, 2, 7, 5, 'Accessibilité des cheminements non linéaire - Diagnostique accessibilité 2014 Toulouse Métropole7', 17, 5, 14),
    (3, 2, 7, 5, 'Accessibilité autour des établissements recevant du public - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 15),
    (3, 2, 7, 5, 'Dispositif d''information - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 16),
    (3, 2, 7, 5, 'Ressauts non conforme - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 17),
    (3, 2, 7, 5, 'Qualité du revêtement - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 18),
    (3, 2, 7, 5, 'Escaliers accessible ou non accessible - Diagnostique accessibilité 2014 Toulouse Métropole', 17, 5, 19),
    (3, 2, 7, 5, 'Sanisettes - Toulouse', 17, 5, 20),
    (1, 2, 8, 6, 'Offre de transport - Landes', 4, 1, 21),
    (1, 2, 8, 6, 'Arrêts, horaires et parcours théoriques des réseaux de transport public des membres du syndicat Nouvelle-Aquitaine Mobilités', 19, 3, 22),
